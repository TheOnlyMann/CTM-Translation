$function death_tax:tax/slot/amt {location:"equipment.$(armor)",check:"armor.$(armor)",phys:"entity @s"}
...
$data modify storage death_tax:storage root.temp.slot set value "armor.$(armor)"
