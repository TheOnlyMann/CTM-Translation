...
tellraw @p {"bold":true,"clickEvent":{"action":"run_command","value":"/trigger shanger.trigger set 1"},"color":"#FFEB9C","hoverEvent":{"action":"show_text","value":[{"text":"클릭하여 체크포인트 보기"}]},"text":"[체크포인트 보기]"}

tellraw @p {"bold":true,"clickEvent":{"action":"run_command","value":"/trigger shanger.trigger set 2"},"color":"#FFB3E6","hoverEvent":{"action":"show_text","value":[{"text":"클릭하여 맵 진행 상황 보기"}]},"text":"\n[맵 진행 상황 보기]"}

tellraw @p {"bold":true,"clickEvent":{"action":"run_command","value":"/trigger shanger.trigger set 3"},"color":"#99EBFF","hoverEvent":{"action":"show_text","value":[{"text":"클릭하여 멋진 통계 보기"}]},"text":"\n[통계 보기]"}
